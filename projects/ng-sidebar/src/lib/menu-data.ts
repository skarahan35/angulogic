// import { SidebarModel, Banner, User, Search, SidebarData, MenuData, SidebarOptions, ResizeEvent } from "./sidebar.model";
...
//     onThemeChange: () => console.log(`Theme changed to`),
//     onResizing: (event:ResizeEvent) => console.log('Sidebar resized'),
//     onExpand: (event:ResizeEvent) => console.log('Sidebar expanded'),
//     onCollapse: (event:ResizeEvent) => console.log('Sidebar collapsed')
//   })
// });
